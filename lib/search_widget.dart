  ...
  void init() {
    ...
    _controller.addListener(() {
      ...
      if (text.trim().isNotEmpty) {
        _tempList!.clear();
        final List<T?> filterList = widget.queryBuilder(text, widget.dataList);
        if (filterList == null) {
          throw Exception(
    ...
    KeyboardVisibilityBuilder(
      ...
      } as Widget Function(BuildContext, bool), // this widget goes to the builder's child property. Added for better performance.
    );
